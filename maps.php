...
<html>
  ...
  <body>
    <input id="pac-input" class="controls white" type="text" placeholder="Enter a location" name="lokasi" required>
    <div id="map"></div>
    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: -6.9034443, lng: 107.5731164},
          zoom: 9
        });
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCC1mRyBOdHu7VrDMx-f-Ugh6Gv52EeyYQ&libraries=places&callback=initMap"
        async defer></script>
  </body>
</html>